...
DAT.conditions = {'pain_socHigh' 'pain_socLow'};
...
DAT.subfolders = {'Pain_SocHigh' 'Pain_SocLow'};
...
DAT.functional_wildcard = {'*.img.gz' '*.img.gz'};
...
% special characters.
DAT.contrastnames = {'pain_SocHigh_vs_SocLow'};
