...
for i = 1:size(cimgs{5},1)
    subjids = [subjids; cimgs{1,12}{i}(99:103)];
end
...
nps_table = addvars(nps_table, subjids) % add subject IDs as first column

save(fullfile(resultsdir,'npsvals_ma_citalopram.mat'), 'nps_table') % save
