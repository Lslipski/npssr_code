...
dat = load(fullfile(datadir, 'npsvals_ma_citalopram.mat'));

% grab subject column from nps values to get subjids
subjids = table2cell(dat.nps_table(:,13));
...
% ------------------------------------------------------------------------
DAT.Description.Experiment_Name = 'Serotonin transporter polymorphism alters citalopram effects on human pain responses to physical pain';
