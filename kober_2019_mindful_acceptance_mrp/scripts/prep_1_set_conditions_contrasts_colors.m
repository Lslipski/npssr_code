...
DAT.conditions = {'acc_img_neg' 'acc_img_neu' 'acc_tmp_neg' 'acc_tmp_neu' ...
                   'constant' ...
                   'rea_img_neg' 'rea_img_neu' 'rea_tmp_neg' 'rea_tmp_neu'};
...
DAT.functional_wildcard = {'*acc_img_neg.img*' '*acc_img_neu.img*' '*acc_tmp_neg.img*' '*acc_tmp_neu.img*' ...
                           '*Constant.img*' ...
                           '*rea_img_neg.img*' '*rea_img_neu.img*' '*rea_tmp_neg.img*' '*rea_tmp_neu.img*'};
